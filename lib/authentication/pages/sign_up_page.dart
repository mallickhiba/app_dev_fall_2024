...
import 'package:iba_course_2/authentication/widgets/google_button.dart';
import 'package:iba_course_2/authentication/widgets/sign_in_up_button.dart';
import 'package:iba_course_2/authentication/widgets/text_button.dart';
import 'package:iba_course_2/authentication/auth_service.dart';
import 'package:iba_course_2/authentication//widgets/input_field.dart';
...
class MySignUpPage extends StatelessWidget {
  ...
  Future<void> googleSignUp(BuildContext context) async {
    ...
    if (retStr == 'account already exists') {
      message =
          'A profile is already associated with this account. Please sign in.';
    } else if (retStr == 'error') {
      message = 'Unexpected Error! Please try again later.';
    }

    if (retStr != 'user did not select account' &&
        retStr != 'sign up successful') {
